...
export GITHUB_REPO=prometheus/pushgateway
...
export DOCKER_REPO=lwolf/pushgateway
...
do
    ...
    wget -O- https://github.com/prometheus/pushgateway/releases/download/${VERSION}/pushgateway-${CLEAN_VERSION}.linux-${ARCH}.tar.gz | tar xvz
    cp -R pushgateway-${CLEAN_VERSION}.linux-${ARCH}/pushgateway .
    ...
    rm -Rf pushgateway pushgateway-${CLEAN_VERSION}.linux-${ARCH}
done
