...
export GITHUB_REPO=prometheus/alertmanager
...
export DOCKER_REPO=lwolf/alertmanager
...
do
    ...
    wget -O- https://github.com/prometheus/alertmanager/releases/download/${VERSION}/alertmanager-${CLEAN_VERSION}.linux-${ARCH}.tar.gz | tar xvz
    cp -R alertmanager-${CLEAN_VERSION}.linux-${ARCH}/{alertmanager,alertmanager.yml,amtool} .
    ...
    rm -Rf {alertmanager,alertmanager.yml,amtool} alertmanager-${CLEAN_VERSION}.linux-${ARCH}
done
