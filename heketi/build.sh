...
export GITHUB_REPO=heketi/heketi
...
export DOCKER_REPO=lwolf/heketi
...
do
    ...
    wget -O- https://github.com/heketi/heketi/releases/download/${VERSION}/heketi-${VERSION}.linux.${ARCH}.tar.gz | tar xvz
