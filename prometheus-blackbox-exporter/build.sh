...
export GITHUB_REPO=prometheus/blackbox_exporter
...
export DOCKER_REPO=lwolf/blackbox-exporter
...
do
    ...
    rm -Rf {blackbox_exporter,blackbox.yml} blackbox_exporter-${CLEAN_VERSION}.linux-${ARCH}
done
